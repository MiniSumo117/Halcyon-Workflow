...
;The function "DvorakQwerty" resides in the "Sumo Dvorak Functions" and 
;takes in two chars. The first is for Dvorak and the second is for Qwerty

;-----------------Number Row Raw---------------
$1::  SendRaw, % DvorakQwerty("$","1")          return
$2::  SendRaw, % DvorakQwerty(Chr(34),"2")      return  ;Chr(34) is ansi for "
...
$+2:: SendRaw, % DvorakQwerty(Chr(39),Chr(34))  return  ;Chr(39) is ansi for '
